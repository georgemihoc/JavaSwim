...
//    public ServiceParticipant(IRepository<Integer, model.Participant> repoParticipant){
...
//    public model.Inscriere addInscriere(model.Inscriere inscriere){
//        if(findInscriere(inscriere.getIdParticipant(),inscriere.getIdProba())!= null){
//            return null;
//        }
//        repoInscriere.save(inscriere);
//        for (model.Proba proba:
//                repoProba.findAll()) {
//            if(proba.getIdProba()==inscriere.getIdProba()){
//                repoProba.update(inscriere.getIdProba(),new model.Proba(inscriere.getIdProba(),proba.getLungime(),proba.getStil(),proba.getNrParticipanti()+1));
//            }
//        }
